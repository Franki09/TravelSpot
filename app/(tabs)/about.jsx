...
export default function About() {
  return (
    <ScrollView className="flex-1 bg-black px-6 py-8">
      <Text className="text-3xl font-bold text-orange mb-4">TravelSpot 🌍</Text>
      ...
      <Text className="text-xl font-semibold text-orange-light mb-2">Sobre la app</Text>
      ...
      <Text className="text-xl font-semibold text-orange-light mb-2">Tecnologías utilizadas</Text>
      <Text className="text-beige-light mb-6">
        • React Native + Expo{"\n"}• Expo Router{"\n"}• NativeWind (TailwindCSS){"\n"}• AsyncStorage{"\n"}
      </Text>

      <Text className="text-xl font-semibold text-orange-light mb-2">Objetivo del proyecto</Text>
      <Text className="text-beige-light mb-6">
      ...
      <Text className="text-xl font-semibold text-orange-light mb-2">Sobre el desarrollador</Text>
      <Text className="text-beige-light">
        Desarrollada por <Text className="font-bold text-green">Franco Gómez Rosell</Text>, apasionado por el desarrollo front-end
